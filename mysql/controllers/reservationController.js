...
export async function makeReservation(id_reservation, id_touriste, etablissement_id, dateReservation, debut_temp, fin_temp, nombrePersonne){
    const [result]= await pool.query(`
            INSERT INTO reservation(id_reservation, id_touriste, etablissement_id, dateReservation, debut_temp, fin_temp, nombrePersonne)
            VALUES(?,?,?,?,?)
    `,[id_reservation, id_touriste, etablissement_id, dateReservation, debut_temp, fin_temp, nombrePersonne])
